    ...
    <section className='section'>
      <div className={styles.about}>
        ...
        <p className={styles.aboutParagraph}>
          ...
          incidunt a nulla impedit cupiditate porro eveniet distinctio? Ex iste
          nostrum accusamus veniam aut ullam suscipit, dicta expedita enim at
          consequuntur animi voluptatem obcaecati perferendis assumenda
          doloribus atque esse maxime mollitia. Quidem ut ea maiores, quo cumque
          eius.
        </p>
      </div>
    </section>
