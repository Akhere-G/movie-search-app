  ...
  return (
    <section className='section'>
      ...
      <p className={styles.contactParagraph}>
        ...
        consequuntur totam eos consectetur. Iste est ullam magni, illum ea odio
        tenetur adipisci aut? Voluptates quae aliquid consectetur architecto
        tempore maiores molestiae. Tempora vitae magni doloribus, incidunt a
        nulla impedit cupiditate porro eveniet distinctio?
      </p>
    </section>
  );
};
